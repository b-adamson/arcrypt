//! Schemas for `instructions/relayer/fees/pool/`.

use crate::{AccountSpec, ArgSpec};

/// Source: `collect_relayer_fees_v17` (v17 IDL).
...
/// Source: `initialise_total_volume_for_relayer_fee_vault_v17` (v17 IDL).
...
/// Source: `initialise_relayer_fee_vault_v17` (v17 IDL).
pub(crate) const INITIALISE_UNIFIED: &[AccountSpec] = schema_base!(
    signer = "relayer",
    fee_payer = "fee_payer",
    user = [
        ("fee_vault",        w = true , s = false),
...
pub(crate) const INITIALISE_UNIFIED_ARGS: &[ArgSpec] = args!(
    computation_offset:       ComputationOffset,
    instruction_seed:         InstructionSeed,
    fee_vault_offset:         AccountOffset,
    mpc_callback_data_offset: AccountOffset,
