...
function AuctionCard({ item }: { item: AuctionSummary }) {
  ...
  return (
    <Link
      href={`/bid?auctionPk=${encodeURIComponent(item.auctionPk)}`}
      className="block w-full overflow-hidden rounded-none border border-white/10 bg-white/[0.04] shadow-[0_18px_70px_rgba(0,0,0,0.28)] backdrop-blur-xl transition hover:bg-white/[0.06]"
    >
